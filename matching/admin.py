...
from .models import UserProfile, UserCV, JobPosting, MatchScore, ApplicationAttempt


@admin.register(UserProfile)
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'display_name', 'match_threshold', 'daily_limit', 'is_active', 'created_at']
    ...
    fieldsets = (
        ...
        ('Configuración de Matching', {
            'fields': ('match_threshold', 'daily_limit', 'min_pause_seconds', 'max_pause_seconds'),
...
class MatchScoreAdmin(admin.ModelAdmin):
    list_display = ['user', 'job_posting_title', 'score', 'is_above_threshold', 'created_at']
