...
def encrypt_existing_credentials(apps, schema_editor):
    ...
    try:
        ...
        for profile in profiles:
            ...
            if profile.smtp_password and not is_credential_encrypted(
            ...
            if updated:
                profile.save(
                    update_fields=["smtp_password", "dv_username", "dv_password"]
                )
                encrypted_count += 1
        ...
        print(
            "Advertencia: No se pudo importar el módulo de encriptación. Las credenciales permanecen sin encriptar."
        )
...
def decrypt_existing_credentials(apps, schema_editor):
    ...
    try:
        ...
        print(
            "Advertencia: No se pudo importar el módulo de encriptación. No se pudo hacer rollback."
        )
    except Exception as e:
