#!/bin/bash
# Script para verificar si hay realmente un scraping en curso en el servidor

echo "🔍 Verificando estado del scraping en el servidor..."
echo ""
...
echo ""
echo "📋 3. Verificando logs recientes de scraping:"
echo "=========================================="
docker logs postulamatic-postulamatic_web-1 --tail 50 2>&1 | grep -i "scraping\|scrape_dvcarreras\|task.*6ec19dc5\|lock" | tail -20 || echo "No se encontraron logs recientes"

echo ""
echo "📋 4. Verificando información del lock:"
echo "=========================================="
docker exec postulamatic-postulamatic_web-1 python manage.py shell << 'PYTHON_EOF'
from matching.services.scraping_lock import scraping_lock
